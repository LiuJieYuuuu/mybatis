...
<div class="place">
    ...
    <ul class="placeul">
        <li><a href="#">首页</a></li>
        <li><a href="#">添加面试信息</a></li>
    </ul>
</div>

<div class="formbody" >
    <div class="formtitle"><span>添加面试信息</span></div>
    <form action="doAddInterview" name="form1" method="post">
    <ul class="forminfo">
        <li><label>学员班级</label>
        ...
        <li><label>面试时间</label><input name="iTime" type="Date" class="dfinput" /></li>
        <li><label>面试企业</label>
        ...
        <li><label>面试内容</label><input name="iContent" type="text" class="dfinput"></li>
        <li><label>面试地点</label><input name="iLoc" type="text" class="dfinput" /></li>
        <li><label>面试结果</label>
            <select name="iResult" id="result" style="line-height: 40px;margin-top: 10px;width: 50px;border: 1px solid #CCCCCC">
