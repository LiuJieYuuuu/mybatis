...
<div class="formbody" >
    <div class="formtitle"><span>企业基本信息</span></div>
    <form action="addEnterprise" method="post" name="form1">
    <ul class="forminfo">
        <li><label>企业名称</label><input name="name" type="text" class="dfinput" /></li>
        <li><label>企业地点</label><input name="loc" type="text" class="dfinput" /></li>
